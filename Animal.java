...
class Animal {
    ...
    public Animal(String typeAnimal, String arrivalDate, String feedingType, String birthdate, String weight, String feedingFrequency, boolean hasVaccines, int animalId){
    ...
    void diseases(String disease){ //lista de enferemedades
